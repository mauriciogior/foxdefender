...
var personagem = 'img/chara1.png';
var inimigo = 'img/icon0.png';

game.preload(personagem, inimigo); // preload image
game.fps = 20;
...
game.onload = function(){
    ...
    var Player = enchant.Class.create(enchant.Sprite, {
        initialize: function(){
            ...
            this.image = game.assets[personagem];
    ...
    var Apple = enchant.Class.create(enchant.Sprite, {
        initialize: function(){
            ...
            this.image = game.assets[inimigo]; // set image
    ...
    var Enemy = enchant.Class.create(enchant.Sprite, {
        initialize: function(){
            enchant.Sprite.call(this, 32, 32);
            this.image = game.assets[personagem]; // set image
